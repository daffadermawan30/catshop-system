...
@section('title', 'Tambah Paket Grooming')
@section('header', 'Tambah Paket Grooming')
...
<div class="max-w-xl">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form action="{{ route('admin.grooming-packages.store') }}" method="POST">
            @csrf

            <x-form-input name="name" label="Nama Paket"
                :value="old('name')" placeholder="Contoh: Full Grooming" :required="true" />
            ...
            <div class="grid grid-cols-2 gap-4">
                <x-form-input name="price" label="Harga (Rp)" type="number"
                    :value="old('price')" placeholder="Contoh: 100000" :required="true" />
                <x-form-input name="duration_minutes" label="Estimasi Durasi (menit)" type="number"
                    :value="old('duration_minutes', 60)" placeholder="Contoh: 60" :required="true" />
            </div>
            ...
            <div class="mb-4 flex items-center gap-2">
                ...
                <label for="is_active" class="text-sm text-gray-700">Paket aktif dan bisa dipilih</label>
            </div>
